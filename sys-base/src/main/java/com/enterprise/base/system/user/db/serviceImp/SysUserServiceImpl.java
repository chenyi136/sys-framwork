package com.enterprise.base.system.user.db.serviceImp;
...
import com.enterprise.base.system.user.db.SysUserMapper;
...
public class SysUserServiceImpl extends ServiceImpl<SysUserMapper, SysUserEntity> implements
    ...
    @Override
    public SysUserEntity authenticate(String name, String password) throws Exception {
        return null;
    }
